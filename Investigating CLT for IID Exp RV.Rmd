...
The mean of the simulated distribution and that of the theoretical distribution are extremely close. The difference is `r meandiff`%.
...
The standard deviation of the simulated distribution is also pretty close to the theoretical standard deviation. The difference is `r sddiff`%.
